...
import net.merise.platform.orm.base.NumberDetail;
...
import net.merise.platform.orm.mapper.NumberDetailDAO;
import net.merise.platform.service.HouseNumberService;
